<template>
	<view>
		<view class="dh_top" :class="bg_img?'cf':''" :style="style+'background:'+bg_color+';'">	
		...
		<view id="a_1" v-if="have_top" class="dh_top dh_top1" :style="'height: '+CustomBar+'px;background-color:'+bg_color"></view>
	</view>
</template>
