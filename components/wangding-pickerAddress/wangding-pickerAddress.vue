<template>
	<picker @change="bindPickerChange" @columnchange="columnchange" :data-index1="index1" :data-index="index" :range="array" range-key="name" :value="value" mode="multiSelector">
		<slot></slot>
	</picker>
</template>
		...
		methods:{
			...
			bindPickerChange(e) {
				...
				this.$emit('change', {
					...
					p_index1:e.currentTarget.dataset.index1,
				})
				return this
			}
