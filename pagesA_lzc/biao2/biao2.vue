...
<template>
	...
	<view class="content">
		...
		<!-- <topbar :have_top="true" bg_color="#F43B31">
			<text @click="back" class="iconfont icon-back-line backIcon"></text>
			<text>中止交易</text>
		</topbar> -->
		<view class="topBg">
			<image src="/static/images/lzc/biao/bg2.png" mode="scaleToFill"></image>
			<view class="topBody dis_flex aic ju_c">
				<text class="tbox2">退款金额:</text>
				<text class="fs12 tb_text1">￥</text>
				<text class="fs24 fwb tb_text1">9999.99</text>
			</view>
			<view class="AboutTheProject bs dis_flex_c">
				...
				<image class="sanjiao" src="/static/images/lzc/biao/zhon.png" mode="heightFix"></image>
			</view>
		</view>
		<view class="progress">
			...
			<view class="pro_sl bs dis_flex aic ju_b">
				<view class="pro_sl_item bs dis_flex_c aic ju_c fs11">
					<text>2021.06.04</text>
					<text>选定服务者</text>
				</view>
				<view class="pro_sl_z dis_flex aic ju_c">
					<view class="pro_sl_hr dis_flex aic ju_c"></view>
		...
		<view class="bfoot bs dis_flex aic ju_b">
			...
			<view class="f_right ju_c aic dis_flex" @click.stop="jump" data-url="/pagesA_lzc/SendTender/SendTender">
				发布此类需求
			</view>
		</view>
	</view>
	...
	.content {
		...
		.AboutTheProject {
			...
			.sanjiao {
				// width: 0;
				// height: 0;
				// border-top: 136upx solid red;
				// border-left: 136upx solid transparent;
